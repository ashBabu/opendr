...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'panoptic_segmentation_efficient_ps = opendr_perception.panoptic_segmentation_efficient_ps:main',
            'panoptic_segmentation_efficient_lps = opendr_perception.panoptic_segmentation_efficient_lps:main',
            'point_cloud_2_publisher = opendr_perception.point_cloud_2_publisher:main',
